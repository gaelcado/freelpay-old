export const translations = {
  en: {
    ...
    createInvoice: {
      ...
      uploadInvoice: 'Upload Quote/Invoice',
      invoiceNumber: 'Quote Number',
      clientName: 'Client Name',
      amount: 'Amount',
      dueDate: 'Due Date',
      createButton: 'Create Quote',
      uploadDescription: 'Upload your quote/invoice file',
      ...
      uploadSuccessTitle: 'Quote Uploaded',
      uploadSuccessDescription: 'Your quote has been successfully uploaded and processed.',
      uploadErrorDescription: 'Failed to upload quote. Please try again.',
    }
  },
  fr: {
    common: {
    ...
    invoice: {
      ...
      upload: 'Télécharger un devis/facture',
      amount: 'Montant',
    ...
    createInvoice: {
      ...
      uploadInvoice: 'Télécharger un devis/facture',
      invoiceNumber: 'Numéro de devis',
      clientName: 'Nom du client',
      amount: 'Montant',
      dueDate: 'Date d\'échéance',
      createButton: 'Créer le devis',
      uploadDescription: 'Téléchargez votre fichier de devis/facture',
      ...
      uploadSuccessTitle: 'Devis téléchargé',
      uploadSuccessDescription: 'Votre devis a été téléchargée et traité avec succès.',
      uploadErrorDescription: 'Échec du téléchargement du devis. Veuillez réessayer.',
    }
  }
} 